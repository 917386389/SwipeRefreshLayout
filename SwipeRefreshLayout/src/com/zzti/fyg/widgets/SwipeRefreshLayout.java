...
import com.example.com.zzti.fyg.R;
import com.zzti.fyg.utils.DisplayUtil;
...
//		setEnabled(a.getBoolean(0, true));
		...
		finished_drawable = a.getResourceId(R.styleable.swiperefresh_finishedImage, R.drawable.ic_done_grey600_18dp);
	 ...
	 */
	public void setRefreshing(boolean refreshing,String msg) {
	...
	public void setLoading(boolean loading,String msg) {
		if (mLoading != loading) {
			tmpLoading = loading;
			if(loading) {
				mLoading = loading;
